...
class ReservationServiceTest {
    ...
    void create_secondReservationGetsPosition2() {
        ...
        Reservation existing = new Reservation(member, book, LocalDate.now(), ReservationStatus.PENDING, 1);
    ...
    void cancel_happyPath_rebuildsQueue() {
        ...
        Reservation r1 = new Reservation(member, book, LocalDate.now(), ReservationStatus.PENDING, 1);
        Reservation r2 = new Reservation(m2, book, LocalDate.now(), ReservationStatus.PENDING, 2);
        Reservation r3 = new Reservation(m3, book, LocalDate.now(), ReservationStatus.PENDING, 3);
    ...
    void cancel_alreadyCancelledReservation_throws() {
        Reservation r = new Reservation(member, book, LocalDate.now(), ReservationStatus.CANCELLED, 1);
    ...
    void notifyNextInQueue_skipsReadyForPickupAndNotifiesNextPending() {
        Member m2 = new Member(2L, new Email("eva@example.sk"), "Eva", "K", MemberRole.MEMBER);
        Reservation r1 = new Reservation(member, book, LocalDate.now(), ReservationStatus.READY_FOR_PICKUP, 1);
        Reservation r2 = new Reservation(m2, book, LocalDate.now(), ReservationStatus.PENDING, 2);
    ...
    void expireReadyReservations_noExpiredReservations_nothingHappens() {
        Reservation r = new Reservation(member, book, LocalDate.now(), ReservationStatus.READY_FOR_PICKUP, 1);
    ...
    void findByMember_returnsOnlyMembersReservations() {
        Reservation r = new Reservation(member, book, LocalDate.now(), ReservationStatus.PENDING, 1);
